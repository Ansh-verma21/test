...
function Adclient({ slide, here }) {
  ...
  const fetchDistricts = (value) => {
    axios.post("https://test-k4h3.onrender.com/get-dist", { dis_name: value })
      .then((res) => {
  ...
  const fetchLocations = (value) => {
    axios.get("https://test-k4h3.onrender.com/location-select")
      .then((res) => {
  ...
  const fetchCities = (value) => {
    axios.post("https://test-k4h3.onrender.com/get-cities", { name: value })
      .then((res) => {
  ...
  function adcl(event) {
    ...
    if (chaname === 1 && changing === 1 && checkpw === 1 && formData.login !== "" &&
      ...
      axios.post("https://test-k4h3.onrender.com/add2", dataToSend)
        .then(() => {
          setdone(1);
          setchan(0);
          setname(0);
  ...
  useEffect(() => {
    if (called === 1) {
      if (formData.username) {
        axios.post("https://test-k4h3.onrender.com/get-name", {
      ...
      axios.post("https://test-k4h3.onrender.com/get-name", { client_name: formData.name })
        .then((res) => {
