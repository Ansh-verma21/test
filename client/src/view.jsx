...
function View(props) {
  ...
  function chit() {
    ...
    axios.post("https://test-k4h3.onrender.com/change", {
      st: i === "OFF" ? 0 : 1,
      id: props.id_view,
    })
      .then((res) => {
  ...
  function chitt() {
    axios.post("https://test-k4h3.onrender.com/checki", {
      id: props.id_view
    }).then((res) => {
      setcon(res.data);
    });

    axios.post("https://test-k4h3.onrender.com/find", props).then((res) => {
      setdata(res.data);
    });
  }
